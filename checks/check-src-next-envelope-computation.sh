...
grep -q '^Group        | Envelope | Allocated | Spent | Balance |  % | Avg/day | Health$' "$human_out"
grep -q '^life_primary | 食費     |      1000 |   350 |     650 | 35 |      87 | SAFE  $' "$human_out"
grep -q '^life_primary | 日用品   |  500 |       80 |       420 | HELD  $' "$human_out"
grep -q '^life_primary | 謎       |       300 |     0 |     300 | unknown_role$' "$human_out"
