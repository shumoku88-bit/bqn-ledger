...
checks=(
  ...
  check-plan-finish-replenish-ui.sh check-command-hub-household-routing.sh check-workflow-drift.sh check-structured-ui-boundary.sh check-ui-preferences.sh
