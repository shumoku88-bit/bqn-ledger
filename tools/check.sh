...
checks=(
  ...
  check-issue-close-debug.sh check-edit-bqn-issue-close.sh check-issue-due-compatibility.sh check-edit-bqn-journal-list.sh check-edit-bqn-journal-cleanup-plan.sh
