...
checks=(
  ...
  check-plan-finish-replenish-ui.sh check-command-hub-recovery.sh check-command-hub-drilldown.sh check-command-hub-home.sh check-home-calendar.sh check-home-calendar-selector.sh check-home-logical-navigation.sh check-home-single-observation-frame.sh check-workflow-drift.sh check-structured-ui-boundary.sh check-ui-preferences.sh
