...
checks=(
  ...
  check-plan-finish-replenish-ui.sh check-command-hub-recovery.sh check-command-hub-drilldown.sh check-home-calendar.sh check-workflow-drift.sh check-structured-ui-boundary.sh check-ui-preferences.sh
