...
現在進行中:
- [ ] `snapshot` セクションの ViewModel JSON 設計の合意 (設計書: [docs/SNAPSHOT_SECTION_JSON_EXPORT_DESIGN.md](docs/SNAPSHOT_SECTION_JSON_EXPORT_DESIGN.md))
- [ ] `snapshot` セクションの ViewModel JSON 実装と検証
