...
Current baseline:
- campaign map は PR #123 で main に受理済み
...
- [ ] current JPY / single-amount assumptions を repo-wide に docs-only で観察・分類する
- [ ] runtime / tests / fixtures / source TSV を Stage 0 では変更しない
