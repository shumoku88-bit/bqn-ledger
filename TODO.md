...
Last hygiene pass: 2026-07-11 — Read-only Event Lens Slice 2: Pure TSV Formatter is complete. No next active finite slice selected; choose one candidate through a separate docs-only selection PR.
