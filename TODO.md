...
- [x] Completed reproducible tracked final-cutover inventory; after config extraction it measures 69 modules, 26 live editor import files, 78 named tests, 33 named checks, 35 fixture families, and seven route/consumer owners.
...
- [ ] Extract the remaining 26 live editor files from 11 `src_next` dependencies without forwarding wrappers; editor config no longer imports old report policy, and no fallback/forwarding owner was added.
