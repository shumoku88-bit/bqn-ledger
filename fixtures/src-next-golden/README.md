...
- Declares its Actual Journal, Account currency, and current policy fields explicitly; editor/UI proofs do not rely on repository config or currency fallback.
