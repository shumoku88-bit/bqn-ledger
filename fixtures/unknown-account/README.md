...
This fixture is used to verify that the linter and report engine's strict validation path fail cleanly when an undefined account is referenced in `journal.tsv`.
