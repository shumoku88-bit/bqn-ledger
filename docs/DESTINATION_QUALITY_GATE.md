...
| P10 composition | green | green: core pure; I/O isolated in application boundary | green: nine narrow composers plus explicit ownership adapters | green: all nine individual CLI routes reuse public evidence/goldens | **incomplete**: `all`/cache/operations/cutover | in progress |
