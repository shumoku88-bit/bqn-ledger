...
- [`ENVELOPE_BACKING_CAPABILITY.md`](ENVELOPE_BACKING_CAPABILITY.md) — in-progress strict Envelope/Backing accounting composition with separated evidence systems
