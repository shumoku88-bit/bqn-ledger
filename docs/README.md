...
- Journal source migration: [JOURNAL_EXTERNAL_PLAN_REFERENCE_PROFILE_PREREQUISITE_PLAN.md](JOURNAL_EXTERNAL_PLAN_REFERENCE_PROFILE_PREREQUISITE_PLAN.md) が現在選定中の有限前提。legacy actualの`plan-id`をexternal unresolved historical referenceとして明示profileで保持しつつ、default `Parse`のstrict behaviorと内部cross-link検査を維持する。親の [JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md](JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md) はselectedだがblockedで、converter implementationはstopped / not started。legacy metadata/profile prerequisiteは [JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md) として完了済み。production source truth / report routingはTSVのままで、reconstruction / default writer / cutoverを選定しない。native multi-posting explicit-path append editor の完了記録は [JOURNAL_NATIVE_MULTI_POSTING_APPEND_EDITOR_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_NATIVE_MULTI_POSTING_APPEND_EDITOR_PLAN-2026-07-22.md)
...
| Journal source migration | [../TODO.md](../TODO.md), [JOURNAL_EXTERNAL_PLAN_REFERENCE_PROFILE_PREREQUISITE_PLAN.md](JOURNAL_EXTERNAL_PLAN_REFERENCE_PROFILE_PREREQUISITE_PLAN.md), [JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md](JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md), [JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md) | Status: external plan reference profile prerequisite selected. The converter remains selected but blocked; implementation is stopped and not started. Default Parse stays strict, schemas stay unchanged, and production routing, writers, TSV source truth, reconstruction, and cutover remain unchanged and blocked. |
