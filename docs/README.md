...
- レポート section 変更: [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md), [REPORT_SECTION_CONTRACT_CHECKLIST.md](REPORT_SECTION_CONTRACT_CHECKLIST.md)。numeric owner alignment の選定済み計画は [REPORT_PROJECTION_ALIGNMENT_PLAN-2026-07-15.md](archive/active-plans/REPORT_PROJECTION_ALIGNMENT_PLAN-2026-07-15.md)、Actual Comparison runtime完了記録は [ACTUAL_COMPARISON_NUMERIC_OWNER_RUNTIME_MIGRATION-2026-07-15.md](archive/completed-plans/ACTUAL_COMPARISON_NUMERIC_OWNER_RUNTIME_MIGRATION-2026-07-15.md)。temporal semantics は [TIME_AS_AXIS.md](TIME_AS_AXIS.md) を正本とし、Daily Trend は [DAILY_TREND_TEMPORAL_CURRENT.md](DAILY_TREND_TEMPORAL_CURRENT.md)、Outlook は [OUTLOOK_TEMPORAL_CURRENT.md](OUTLOOK_TEMPORAL_CURRENT.md) をcurrent entryとして読む
