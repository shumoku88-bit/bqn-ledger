...
| currency awareness | [CURRENCY_AWARENESS_CAMPAIGN_MAP.md](CURRENCY_AWARENESS_CAMPAIGN_MAP.md), [CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md](CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md), [CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md](CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md), [CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md](CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md), [CURRENT_CURRENCY_ASSUMPTION_MAP.md](CURRENT_CURRENCY_ASSUMPTION_MAP.md) | Stage 1 decision が amount/currency semantics の current contract。Stage 2 decision が single-currency domain proof / carrier / gate の current contract。Stage 2 minimal implementation plan が次の narrow runtime slice の範囲。Stage 0 map は observation evidence。 |
