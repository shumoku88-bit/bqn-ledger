...
- レポート section 変更: [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md), [REPORT_SECTION_CONTRACT_CHECKLIST.md](REPORT_SECTION_CONTRACT_CHECKLIST.md)（Daily Trend の未解決 temporal 意味は [DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md)）
...
| src_next report engine | [SRC_NEXT_CURRENT.md](SRC_NEXT_CURRENT.md), [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md) | 旧 engine docs は archive。Daily Trend の temporal 意味は未解決 note [DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md) も参照。 |
