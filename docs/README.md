...
- UI / structured export 境界: [STRUCTURED_UI_EXPORT_CONTRACT.md](STRUCTURED_UI_EXPORT_CONTRACT.md), [PLANNED_SECTION_JSON_EXPORT_DESIGN.md](PLANNED_SECTION_JSON_EXPORT_DESIGN.md), [SNAPSHOT_SECTION_JSON_EXPORT_DESIGN.md](SNAPSHOT_SECTION_JSON_EXPORT_DESIGN.md), [archive/active-plans/SHELL_MEANING_INVENTORY-2026-07-01.md](archive/active-plans/SHELL_MEANING_INVENTORY-2026-07-01.md)
