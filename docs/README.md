...
- レポート section 変更: [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md), [REPORT_SECTION_CONTRACT_CHECKLIST.md](REPORT_SECTION_CONTRACT_CHECKLIST.md)（Daily Trend temporal work は [DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md](DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md) と [DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md](DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md) を current path とし、[DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md) は superseded routing stub として扱う）
...
| Daily Trend temporal semantics | [TIME_AS_AXIS.md](TIME_AS_AXIS.md), [DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md](DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md), [DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md](DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md) | [DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md) は superseded routing stub。具体的 consumer の decision/test は必要時だけ読む。 |
