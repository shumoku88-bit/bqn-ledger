...
- [`REPORT_PORTFOLIO_CONTRACT.md`](REPORT_PORTFOLIO_CONTRACT.md)
- [`DESTINATION_COMPOSITION.md`](DESTINATION_COMPOSITION.md)
- [`ACCOUNT_BALANCES_REPORT.md`](ACCOUNT_BALANCES_REPORT.md)
- [`RECENT_JOURNAL_REPORT.md`](RECENT_JOURNAL_REPORT.md)
- [`PLANNED_PAYMENTS_SECTION.md`](PLANNED_PAYMENTS_SECTION.md)
- [`ENVELOPE_BACKING_CAPABILITY.md`](ENVELOPE_BACKING_CAPABILITY.md)
- [`DAILY_TARGET_REPORT.md`](DAILY_TARGET_REPORT.md)
- [`CYCLE_RESOLUTION.md`](CYCLE_RESOLUTION.md)

## Domain contracts

- [`LEDGER_FACT_SCHEMA.md`](LEDGER_FACT_SCHEMA.md)
- [`PLAN_ID_LIFECYCLE.md`](PLAN_ID_LIFECYCLE.md)
- [`EXTENSION_BOUNDARY.md`](EXTENSION_BOUNDARY.md)
- [`SAFETY_PROFILE.md`](SAFETY_PROFILE.md)

Historical plans, audits, migration inventories, and superseded contracts are under [`archive/`](archive/). They are context, not current runtime instructions.