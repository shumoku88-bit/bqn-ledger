...
- Journal source migration: 選定済み計画は [JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN.md](JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN.md)。budget companion projection characterization の完了記録は [JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN-2026-07-22.md)。production Journal routing / writer / UI / envelope/report runtime migration / conversion / cutover は未選定
...
| Journal source migration | [JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN.md](JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN.md), [Resolved envelope assignment persistence completed record](archive/completed-plans/JOURNAL_RESOLVED_ENVELOPE_ASSIGNMENT_PERSISTENCE_PLAN-2026-07-22.md), [../TODO.md](../TODO.md) | File-backed shadow context は有限計画として選定済み。production Journal routing, writer/editor, envelope/report runtime migration, conversion, cutover は未選定。 |
