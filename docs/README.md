...
- Journal source migration: file-backed shadow context の完了記録は [JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN-2026-07-22.md)。現在は有限slice未選定。production Journal routing / writer / UI / envelope/report runtime migration / conversion / cutover は未選定
...
| Journal source migration | [File-backed shadow context completed record](archive/completed-plans/JOURNAL_FILE_BACKED_SHADOW_CONTEXT_PLAN-2026-07-22.md), [Resolved envelope assignment persistence completed record](archive/completed-plans/JOURNAL_RESOLVED_ENVELOPE_ASSIGNMENT_PERSISTENCE_PLAN-2026-07-22.md), [../TODO.md](../TODO.md) | File-backed shadow context は完了。現在は有限slice未選定。production Journal routing, writer/editor, envelope/report runtime migration, conversion, cutover は未選定。 |
