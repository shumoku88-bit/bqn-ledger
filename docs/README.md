...
- Journal source migration: budget companion projection characterization は [JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN.md](JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN.md) を有限計画として選定（resolved assignment 永続化の完了記録は [JOURNAL_RESOLVED_ENVELOPE_ASSIGNMENT_PERSISTENCE_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_RESOLVED_ENVELOPE_ASSIGNMENT_PERSISTENCE_PLAN-2026-07-22.md)）。production Journal routing / writer / UI / envelope/report runtime migration / conversion / shadow read / cutover は未選定
...
| Journal source migration | [JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN.md](JOURNAL_BUDGET_COMPANION_PROJECTION_CHARACTERIZATION_PLAN.md), [Resolved envelope assignment persistence completed record](archive/completed-plans/JOURNAL_RESOLVED_ENVELOPE_ASSIGNMENT_PERSISTENCE_PLAN-2026-07-22.md), [../TODO.md](../TODO.md) | Budget companion projection characterization は有限計画として選定済み。production Journal routing, writer/editor, envelope/report runtime migration, conversion, shadow read, cutover は未選定。 |
