...
- Journal source migration: Stage 2A/2B/2C、three-posting parity、rehearsal、および resolved-account registry mismatch rejection は test-only で完了。最新の完了記録は [JOURNAL_RESOLVED_ACCOUNT_REGISTRY_MISMATCH_REJECTION_PLAN-2026-07-21.md](archive/completed-plans/JOURNAL_RESOLVED_ACCOUNT_REGISTRY_MISMATCH_REJECTION_PLAN-2026-07-21.md) である。次の有限sliceとして、スプリット購入トランザクションのテスト専用計画 [JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN.md](JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN.md) が選定済み（test-only, production Journal routing / writer / conversion / shadow read / cutover / tax separation は未選定）
...
| Journal source migration | [Split purchase plan](JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN.md), [Mismatch rejection completed record](archive/completed-plans/JOURNAL_RESOLVED_ACCOUNT_REGISTRY_MISMATCH_REJECTION_PLAN-2026-07-21.md), [Read-only carrier completed record](archive/completed-plans/JOURNAL_READ_ONLY_SOURCE_CARRIER_REHEARSAL_PLAN-2026-07-21.md), [Report-context rehearsal completed record](archive/completed-plans/JOURNAL_READ_PATH_REPORT_CONTEXT_REHEARSAL_PLAN-2026-07-21.md), [../TODO.md](../TODO.md) | 最新の有限スライスとして、スプリット購入トランザクションのテスト専用計画 [JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN.md](JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN.md) が選定済み。Stage 2A/2B/2C、three-posting parity、rehearsal、および resolved-account registry mismatch rejection は test-only で完了（production Journal routing不許可）。production routing、writer、conversion、shadow read、cutover、tax separation は未選定。 |
