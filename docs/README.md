...
| currency awareness | [CURRENCY_AWARENESS_CAMPAIGN_MAP.md](CURRENCY_AWARENESS_CAMPAIGN_MAP.md), [CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md](CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md), [CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md](CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md), [CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md](CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md), [CURRENCY_STAGE2_BUILDPERIODVIEW_DOWNSTREAM_BOUNDARY_DECISION.md](CURRENCY_STAGE2_BUILDPERIODVIEW_DOWNSTREAM_BOUNDARY_DECISION.md), [CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_ADMISSION_DECISION.md](CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_ADMISSION_DECISION.md), [CURRENT_CURRENCY_ASSUMPTION_MAP.md](CURRENT_CURRENCY_ASSUMPTION_MAP.md) | Stage 1 decision が amount/currency semantics の current contract。Stage 2 decision が single-currency domain proof / carrier / gate の current contract。Explicit admission decision が JPY / ILS の exact-one-domain proof rule と exact-decimal readiness boundary。BuildPeriodView decision が downstream trusted-precondition boundary。Stage 0 map は observation evidence。 |
