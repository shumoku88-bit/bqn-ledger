...
- Journal source migration: [JOURNAL_POSTING_IR_IDENTITY_PROVENANCE_PARITY_STAGE2B_PLAN.md](JOURNAL_POSTING_IR_IDENTITY_PROVENANCE_PARITY_STAGE2B_PLAN.md) が現在選定中の有限スライス契約。Stage 2Aは完了済みで、rejection、native multi-posting、production routing、writer、cutoverは未選定
...
| Journal source migration | [JOURNAL_POSTING_IR_IDENTITY_PROVENANCE_PARITY_STAGE2B_PLAN.md](JOURNAL_POSTING_IR_IDENTITY_PROVENANCE_PARITY_STAGE2B_PLAN.md) | 現在選定中のtest-only finite slice。Stage 2Aはcompleted record、後続production/rejection/native multi-postingは自動選定しない。 |
