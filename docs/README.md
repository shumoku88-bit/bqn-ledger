...
- Journal source migration: Stage 2A/2B/2C、three-posting parity、rehearsal、resolved-account registry mismatch rejection、および split-purchase transaction characterization は test-only で完了。最新の完了記録は [JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN-2026-07-22.md) である。現在、有限のJournalスライスは未選定（no current finite Journal slice selected; production Journal routing / writer / conversion / shadow read / cutover / tax separation は未選定）
...
| Journal source migration | [Split purchase completed record](archive/completed-plans/JOURNAL_SPLIT_PURCHASE_TRANSACTION_CHARACTERIZATION_PLAN-2026-07-22.md), [Mismatch rejection completed record](archive/completed-plans/JOURNAL_RESOLVED_ACCOUNT_REGISTRY_MISMATCH_REJECTION_PLAN-2026-07-21.md), [Read-only carrier completed record](archive/completed-plans/JOURNAL_READ_ONLY_SOURCE_CARRIER_REHEARSAL_PLAN-2026-07-21.md), [../TODO.md](../TODO.md) | Stage 2A/2B/2C、three-posting parity、rehearsal、resolved-account registry mismatch rejection、および split-purchase transaction characterization は test-only で完了。現在、有限のJournalスライスは未選定（production Journal routing / writer / conversion / shadow read / cutover / tax separation は未選定）。 |
