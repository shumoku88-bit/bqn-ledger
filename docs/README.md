...
- UI / structured export 境界: [STRUCTURED_UI_EXPORT_CONTRACT.md](STRUCTURED_UI_EXPORT_CONTRACT.md), [archive/active-plans/SHELL_MEANING_INVENTORY-2026-07-01.md](archive/active-plans/SHELL_MEANING_INVENTORY-2026-07-01.md)
