...
- currency awareness planning: [CURRENCY_AWARENESS_CAMPAIGN_MAP.md](CURRENCY_AWARENESS_CAMPAIGN_MAP.md), [CURRENT_CURRENCY_ASSUMPTION_MAP.md](CURRENT_CURRENCY_ASSUMPTION_MAP.md)
...
| currency awareness | [CURRENCY_AWARENESS_CAMPAIGN_MAP.md](CURRENCY_AWARENESS_CAMPAIGN_MAP.md), [CURRENT_CURRENCY_ASSUMPTION_MAP.md](CURRENT_CURRENCY_ASSUMPTION_MAP.md) | Stage 0 map は observation evidence。Stage 1 semantics は未選択。 |
