...
- Journal source migration: [JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md](JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md) が現在選定中の有限スライス。legacy metadata/profile prerequisiteは [JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md) として完了し、test-only Minimal BQN Journal profile / Transaction IR / Stage 2A / Stage 2Bで`source_event_id`とbusiness `txn_id`を分離し、legacy `journal.tsv` metadata vocabularyを明示的に保持した。converterはまだ未開始。reconstruction / production source switch / report routing / default writer / cutoverは変更せず、完了後もcutoverを自動選定しない。native multi-posting explicit-path append editor の完了記録は [JOURNAL_NATIVE_MULTI_POSTING_APPEND_EDITOR_PLAN-2026-07-22.md](archive/completed-plans/JOURNAL_NATIVE_MULTI_POSTING_APPEND_EDITOR_PLAN-2026-07-22.md)
...
| Journal source migration | [../TODO.md](../TODO.md), [JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md](JOURNAL_CANONICAL_TSV_NATIVE_PREFIX_CONVERTER_PLAN.md), [JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION-2026-07-22.md](archive/completed-plans/JOURNAL_LEGACY_METADATA_PROFILE_EXTENSION_PLAN-2026-07-22.md) | Status: legacy metadata/profile prerequisite complete; canonical TSV-to-native Journal prefix converter remains selected but implementation has not started. Production routing, writers, source truth, conversion, reconstruction, and cutover remain unchanged and blocked. |
