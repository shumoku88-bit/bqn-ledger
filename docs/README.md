...
- レポート section 変更: [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md), [REPORT_SECTION_CONTRACT_CHECKLIST.md](REPORT_SECTION_CONTRACT_CHECKLIST.md)（Daily Trend temporal work は [DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md](DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md), [DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md](DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md), [DAILY_TREND_HEADER_CONCRETE_TIME_CARRIER_DECISION.md](DAILY_TREND_HEADER_CONCRETE_TIME_CARRIER_DECISION.md) を current path とし、[DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md) は superseded routing stub として扱う）
...
| currency awareness | [CURRENCY_AWARENESS_CAMPAIGN_MAP.md](CURRENCY_AWARENESS_CAMPAIGN_MAP.md), [CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md](CURRENCY_STAGE1_AMOUNT_SEMANTICS_DECISION.md), [CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md](CURRENCY_STAGE2_SINGLE_CURRENCY_DOMAIN_DECISION.md), [CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md](CURRENCY_STAGE2_MINIMAL_DOMAIN_PROOF_IMPLEMENTATION_PLAN.md), [CURRENCY_STAGE2_BUILDPERIODVIEW_DOWNSTREAM_BOUNDARY_DECISION.md](CURRENCY_STAGE2_BUILDPERIODVIEW_DOWNSTREAM_BOUNDARY_DECISION.md), [CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_ADMISSION_DECISION.md](CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_ADMISSION_DECISION.md), [CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_EXACT_DECIMAL_IMPLEMENTATION_PLAN.md](CURRENCY_STAGE2_EXPLICIT_SINGLE_CURRENCY_EXACT_DECIMAL_IMPLEMENTATION_PLAN.md), [CURRENCY_STAGE2_SLICE_B_SPLIT_DECISION.md](CURRENCY_STAGE2_SLICE_B_SPLIT_DECISION.md), [CURRENCY_MIXED_JPY_ILS_DAILY_USE_PLAN-2026-07-12.md](archive/active-plans/CURRENCY_MIXED_JPY_ILS_DAILY_USE_PLAN-2026-07-12.md), [STRICT_PRODUCTION_SOURCE_CURRENCY_ENFORCEMENT_DECISION-2026-07-13.md](archive/active-plans/STRICT_PRODUCTION_SOURCE_CURRENCY_ENFORCEMENT_DECISION-2026-07-13.md), [FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md](archive/active-plans/FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md), [FRIEND_TRAVEL_ATOMIC_FINALIZATION_WRITE_DESIGN-2026-07-13.md](archive/active-plans/FRIEND_TRAVEL_ATOMIC_FINALIZATION_WRITE_DESIGN-2026-07-13.md), [ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md](archive/active-plans/ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md), [CURRENT_CURRENCY_ASSUMPTION_MAP.md](CURRENT_CURRENCY_ASSUMPTION_MAP.md) | Stage 2 docs are the single-currency exact foundation. M1 through M3 are implemented and separately verified. The Israel plan is the selected docs-only daily-capture design. The friend-travel pure preview is implemented and verified; its atomic recovery design is parked as candidate 6 and selects no synthetic transaction or production writer. Israel implementation candidates 1–6, pending storage, strict-source Steps 2–5, and M4 remain unselected. Existing Stage 2 decisions remain current. |
| src_next report engine | [SRC_NEXT_CURRENT.md](SRC_NEXT_CURRENT.md), [REPORT_CONTRACTS.md](REPORT_CONTRACTS.md) | 旧 engine docs は archive。Daily Trend temporal work は [DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md](DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md) → [DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md](DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md) を current path とする。 |
| Daily Trend temporal semantics | [TIME_AS_AXIS.md](TIME_AS_AXIS.md), [DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md](DAILY_TREND_CURRENT_SOURCE_COORDINATE_REPLAY_DECISION.md), [DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md](DAILY_TREND_TEMPORAL_DEPENDENCY_MAP.md), [DAILY_TREND_HEADER_CONCRETE_TIME_CARRIER_DECISION.md](DAILY_TREND_HEADER_CONCRETE_TIME_CARRIER_DECISION.md) | [DAILY_TREND_TEMPORAL_SEMANTICS.md](DAILY_TREND_TEMPORAL_SEMANTICS.md) は superseded routing stub。具体的 consumer の decision/test は必要時だけ読む。 |
...
| editor / 日常入力 | [BQN_EDITOR_USAGE.md](BQN_EDITOR_USAGE.md), [ADD_UI_USAGE.md](ADD_UI_USAGE.md), [MCP_RECEIPT_ENTRY.md](MCP_RECEIPT_ENTRY.md), [PLAN_ID_LIFECYCLE.md](PLAN_ID_LIFECYCLE.md) | MCP receipt pathは画像を扱わず、既存BQN editorへ委譲する。Go editor 関連は historical。 |
