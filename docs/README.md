...
- Journal source migration: Stage 2A/2B/2C、three-posting parity、rehearsal (trial-balance, report-context & read-only carrier) は test-only で完了。最新の記録は [JOURNAL_READ_PATH_TRIAL_BALANCE_REHEARSAL_PLAN-2026-07-21.md](archive/completed-plans/JOURNAL_READ_PATH_TRIAL_BALANCE_REHEARSAL_PLAN-2026-07-21.md), [JOURNAL_READ_PATH_REPORT_CONTEXT_REHEARSAL_PLAN-2026-07-21.md](archive/completed-plans/JOURNAL_READ_PATH_REPORT_CONTEXT_REHEARSAL_PLAN-2026-07-21.md) および [JOURNAL_READ_ONLY_SOURCE_CARRIER_REHEARSAL_PLAN-2026-07-21.md](archive/completed-plans/JOURNAL_READ_ONLY_SOURCE_CARRIER_REHEARSAL_PLAN-2026-07-21.md) で、既存 public Journal fixture が `Parse -> Stage 2A -> BuildPeriodView -> balances.Build / Format` に接続され、単一の read-only carrier 境界で管理される evidence を記録する。次の finite Journal slice、production routing、writer、shadow read、conversion、cutover は未選定
...
| Journal source migration | [Read-only carrier completed record](archive/completed-plans/JOURNAL_READ_ONLY_SOURCE_CARRIER_REHEARSAL_PLAN-2026-07-21.md), [Report-context rehearsal completed record](archive/completed-plans/JOURNAL_READ_PATH_REPORT_CONTEXT_REHEARSAL_PLAN-2026-07-21.md), [Three-posting semantic-coordinate parity completed record](archive/completed-plans/JOURNAL_NATIVE_THREE_POSTING_SEMANTIC_COORDINATE_PARITY_PLAN-2026-07-19.md), [../TODO.md](../TODO.md) | Stage 2A/2B/2C、three-posting parity、trial-balance, report-context & read-only carrier rehearsal は test-only で完了。次の finite Journal slice、production route、writer、shadow read、conversion、cutover、後続 stage は未選定。 |
