...
実際に見たいものは、次の収入日やサイクル終端までの生活・支払いに使える資金です。
...
- 読んですぐ意味がわかる
- ターミナルや ledger に慣れていない人にも伝わりやすい

ただし、正式な表示名としては採用しません。

理由は、「誰が」「何に」「どの範囲で」使える資金なのかが、表示名だけでは少し曖昧になりやすいからです。

この語は、説明文の中で `可用資金` を補足する言い換えとしては使えます。
...
bqn-ledger が本当に見たい「次の収入日まで使える水位」を、より誤解しにくくするための用語整理です。
