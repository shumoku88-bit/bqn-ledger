...
Detailed observation, knowledge-boundary, row-membership, header-owner, carrier, and explicit-empty-identity decisions are implementation history after their selected behavior has been consumed by runtime. They are not mandatory entry documents.
