...
- [SRC_NEXT_STAGE4B_TRIAL_SCOPE.md](file:///Users/user/Projects/moko/bqn-ledger/docs/SRC_NEXT_STAGE4B_TRIAL_SCOPE.md) — Stage 4b daily-use trial scope（observation-only、禁止される advice usage、pause conditions）
...
- [SRC_NEXT_REPLACEMENT_READINESS.md](file:///Users/user/Projects/moko/bqn-ledger/docs/SRC_NEXT_REPLACEMENT_READINESS.md) — 置き換え準備チェックリスト（Stage 1〜5 gate）
...
- [SRC_NEXT_SNAPSHOT_EQUIVALENCE_CRITERIA.md](file:///Users/user/Projects/moko/bqn-ledger/docs/SRC_NEXT_SNAPSHOT_EQUIVALENCE_CRITERIA.md) — production-equivalent Snapshot criteria 定義（Gate A の criteria 文書）
- [SRC_NEXT_MANUAL_COMPARISON_PROCEDURE.md](file:///Users/user/Projects/moko/bqn-ledger/docs/SRC_NEXT_MANUAL_COMPARISON_PROCEDURE.md) — current engine と src_next の手動比較手順（Gate B の手順書）
- [SRC_NEXT_STAGE4_TRIAL_LOG.md](file:///Users/user/Projects/moko/bqn-ledger/docs/SRC_NEXT_STAGE4_TRIAL_LOG.md) — Stage 4 観察ログ template
