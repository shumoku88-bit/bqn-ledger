...
- The selected Israel daily-capture operating choice, including capture-time routing into this pending-event contract, is in [ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md](../completed-plans/ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md). That docs-only plan does not select this plan's atomic writer.
