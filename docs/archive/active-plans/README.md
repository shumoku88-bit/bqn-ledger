...
| `FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md` | active | Canonical finite consumer: its I/O-free one-row JPY pure-preview slice is implemented and verified. The plan remains active only while the future atomic write candidate is neither selected nor declined; writer, strict-source Steps 2–5, and M4 remain unselected. |
