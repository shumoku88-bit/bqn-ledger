...
| `PLAN_TEMPORAL_EXECUTION_COVERAGE_JOIN-2026-07-06.md` | active | Aggregate-only follow-up remains active. Slice A seam reduction was implemented by PR #70. Before Slice B, review the clock drift mapped in `../audits/TEMPORAL_SEMANTICS_OBSERVATION-2026-07-06.md` and decide what explicit `as_of` means. |
