...
| `FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md` | active | Canonical consumer semantics. Its pure one-row JPY preview is implemented and verified; the recoverable synthetic transaction implementation is now selected through the atomic write design. Production use, strict-source Steps 2–5, and M4 remain unselected. |
| `FRIEND_TRAVEL_ATOMIC_FINALIZATION_WRITE_DESIGN-2026-07-13.md` | active plan | Selects `friend_travel_events.tsv`, a derived finalized-row index, and a recoverable events+journal transaction with manifest, backups, stale checks, rollback, and exact retry evidence. Only synthetic-fixture implementation is selected; production writes remain unselected. |
...
| `TRAVEL_MULTI_CURRENCY_SETTLEMENT_DESIGN_INTAKE-2026-07-12.md` | parked | Broad 1–2 month travel-living intake. The selected friend-purchase consumer routes to `FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md`; cash exchange, cards, valuation, and trip review remain parked. |
