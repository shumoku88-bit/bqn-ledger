...
| `../completed-plans/ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md` | historical | Completed by PR #215 as the docs-only decision record for the four Israel operational rails. Read it for semantic background; the selected predeparture implementation sequence is routed through `ISRAEL_PREDEPARTURE_EDITOR_CAPTURE_COMPLETION-2026-07-13.md` and `TODO.md`. |
| `ISRAEL_PREDEPARTURE_EDITOR_CAPTURE_COMPLETION-2026-07-13.md` | active plan | Selected five-PR implementation sequence for ordinary metadata readiness, friend pending capture, exchange pure contract and append, then integrated synthetic rehearsal. Only the immediate phase named by `TODO.md` is authorized; candidate 6, router, cash view, finalization, strict-source Steps 2–5, and M4 remain unselected. |
