...
| `../completed-plans/JOURNAL_POSTING_IR_ADAPTER_PARITY_STAGE2A_PLAN-2026-07-18.md` | historical | Completed bounded test-only success-path adapter parity. One public synthetic actual and one plan transaction pass limited semantic parity; identity/provenance, rejection, native multi-posting, production routing, writer, conversion, and cutover remain unselected. |
