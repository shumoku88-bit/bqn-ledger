...
| `CURRENCY_MIXED_JPY_ILS_DAILY_USE_PLAN-2026-07-12.md` | active | Concrete mixed-ledger daily-use plan. Stage 2 remains the single-currency exact foundation; `TODO.md` currently selects only M1, the checked selected-currency projection seam. M2 and later are not automatically authorized. |
