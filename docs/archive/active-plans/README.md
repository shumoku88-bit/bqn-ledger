...
| `FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md` | active | Canonical finite consumer: pending friend-paid travel source event finalization into one existing-JPY-liability → JPY-expense preview. It selects only a later I/O-free pure validation + one-row preview slice; write path, strict-source Steps 2–5, and M4 remain unselected. |
