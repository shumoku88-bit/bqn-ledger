...
| `REPORT_PROJECTION_ALIGNMENT_PLAN-2026-07-15.md` | active plan | Selected, gated report numeric-owner alignment sequence. Actual Comparison runtime migration is complete in `../completed-plans/ACTUAL_COMPARISON_NUMERIC_OWNER_RUNTIME_MIGRATION-2026-07-15.md`; Outlook / `actual_snapshot` characterization is next selectable but no next slice is selected. |
