...
| `PREFIX_FALLBACK_PRODUCT_SELECTION_REMOVAL_PLAN-2026-07-11.md` | active | One finite audit-promoted safety slice: keep prefix-shaped missing-role visibility diagnostic-only, remove prefix fallback from product/envelope role selection, then return routing to Currency Stage 2 B2. |
