...
| `../completed-plans/ENVELOPE_EVENT_LINKAGE_AUTOMATION_PLAN-2026-07-14.md` | historical | Completed confirmation-gated `plan_id` linkage, idempotent retry, and pending recovery path. Ordinary-income linkage remains a separate unselected TODO candidate. |
