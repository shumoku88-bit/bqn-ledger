...
| `CONFIG_POLICY_CONTINUATION_HANDOFF-2026-07-14.md` | active | Temporary next-session handoff. Resume by jointly deciding `POLICY_RISK_STYLE` meaning and ownership; no runtime change, fallback migration, rename, fixture sweep, or unrelated TODO work is authorized. Root pointer: `NEXT_SESSION.md`. |
