...
| `CURRENCY_STAGE2_B2_ARITHMETIC_OWNERSHIP_RECHECK-2026-07-11.md` | active | Docs-only ownership decision before B2 runtime: compare current `context.bqn` owner with one dedicated pure snapshot-arithmetic module while preserving B2 semantics and exclusions unchanged. |
