...
| `ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md` | active | Current finite docs-only design for Israel daily capture: exchange observations, ordinary ILS cash rows, confirmed-JPY-only own-card rows, and pending friend events. Its ordered implementation candidates 1–6 are all unselected; the atomic writer remains parked as candidate 6. |
...
| `TRAVEL_MULTI_CURRENCY_SETTLEMENT_DESIGN_INTAKE-2026-07-12.md` | parked | Broad 1–2 month travel-living intake. The selected Israel operating choice routes to `ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md`, while friend finalization details route to `FRIEND_TRAVEL_SOURCE_EVENT_JPY_FINALIZATION_PLAN-2026-07-13.md`; other travel rails remain parked. |
