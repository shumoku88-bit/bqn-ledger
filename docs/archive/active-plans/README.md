...
| `REPORT_SECTION_DESCRIPTOR_CENTRALIZATION_PLAN-2026-07-16.md` | active | Selected finite maintenance slice using `../audits/REPORT_SECTION_DESCRIPTOR_OWNERSHIP_AUDIT-2026-07-16.md` as evidence. It centralizes static descriptors only, preserves public output and semantics, leaves `structured_output` meaning to a separate decision, and does not authorize Outlook or other report work. |
