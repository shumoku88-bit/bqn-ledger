...
| `CURRENCY_MIXED_JPY_ILS_DAILY_USE_PLAN-2026-07-12.md` | active backlog | M1 through M3 are implemented and separately verified. No next slice is selected; strict-source enforcement and M4 remain independent candidates and are not automatically authorized. |
