...
| `CONFIGURABLE_AI_ASSISTED_LEDGER_FOUNDATION-2026-07-13.md` | active plan | Selected highest-priority development direction and docs-only synthesis map. Routes Israel readiness first, PR #219 currency-policy integration before program expansion, config/privacy/consultation boundaries next, and PR #211 Observatory last. Only finite work explicitly selected in `TODO.md` is authorized. |
