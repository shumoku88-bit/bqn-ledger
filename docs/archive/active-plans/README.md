...
| `../completed-plans/ISRAEL_TRAVEL_DAILY_CAPTURE_PLAN-2026-07-13.md` | historical | Completed by PR #215 as the docs-only decision record for the four Israel operational rails. Candidates 1–6 remain unselected; read it for background and use `TODO.md` for current work selection. |
