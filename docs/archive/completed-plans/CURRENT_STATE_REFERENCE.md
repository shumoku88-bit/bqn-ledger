...
- [SRC_NEXT_STAGE4A_OBSERVATION_INVENTORY.md](../src-next-migration/SRC_NEXT_STAGE4A_OBSERVATION_INVENTORY.md) — Stage 4a 検証面棚卸し
- [SRC_NEXT_SNAPSHOT_EQUIVALENCE_CRITERIA.md](../src-next-migration/SRC_NEXT_SNAPSHOT_EQUIVALENCE_CRITERIA.md) — production-equivalent Snapshot criteria 定義
- [SRC_NEXT_STAGE4B_READINESS_GATE.md](../src-next-migration/SRC_NEXT_STAGE4B_READINESS_GATE.md) — Stage 4b validation run readiness gate 定義
- [SRC_NEXT_MANUAL_COMPARISON_PROCEDURE.md](../src-next-migration/SRC_NEXT_MANUAL_COMPARISON_PROCEDURE.md) — 手動比較手順の正本（Gate B 充足の手順書）
