...
The default endpoint is `http://127.0.0.1:3000/mcp`. It uses Streamable HTTP only; legacy SSE is not implemented. Do not expose this endpoint directly to the internet.
